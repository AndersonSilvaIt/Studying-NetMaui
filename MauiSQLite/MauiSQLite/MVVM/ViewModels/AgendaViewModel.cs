...
namespace MauiSQLite.MVVM.ViewModels
{
    ...
    {
        [ObservableProperty]
        public List<Contato> _contatos;

        [ObservableProperty]
        public Contato _contatoAtual;
        ...
        private async Task Refresh(IAgendaService agendaService)
        {
            Contatos = await agendaService.GetContatos();
